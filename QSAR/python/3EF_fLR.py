# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 18:31:39 2024
...
# 输出最优参数
print("Best number of features:", grid_search.best_params_['fs__k'])#100
print('Best AUC: %.3f' % grid_search.best_score_)#0.577
...
fi.to_csv('特征重要性/EF_fLR_fimp_3.csv',header=True, index = True)
...
print("在训练集上的正确率:", test_accuracy)#0.542
train_accuracy = model.score(X_train, y_train)
print("在训练集上的正确率:", train_accuracy)#0.677
full_set_accuracy = model.score(X, y)
print("在全集上的正确率:", full_set_accuracy)#0.637
...
EF_RF_ROC.to_csv('ROC曲线/EF_fLR_ROC_3.csv',header=True,index=False);  
...
confmat.to_csv('混淆矩阵/EF_fLR_confmat_3.csv',header=True, index = True)

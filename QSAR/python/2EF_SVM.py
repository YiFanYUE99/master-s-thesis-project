# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 14:14:41 2024
...
print("最优特征数:", best_n_features)#200
...
fi.to_csv('特征重要性/EF_fSVM_fimp_2.csv',header=True, index = True)
...
print("在训练集上的正确率:", test_accuracy)#0.573
train_accuracy = model.score(X_train, y_train)
print("在训练集上的正确率:", train_accuracy)#0.794
full_set_accuracy = model.score(X, y)
print("在全集上的正确率:", full_set_accuracy)#0.728
...
EF_RF_ROC.to_csv('ROC曲线/EF_fSVM_ROC_2.csv',header=True,index=False);  
...
confmat.to_csv('混淆矩阵/EF_fSVM_confmat_2.csv',header=True, index = True)

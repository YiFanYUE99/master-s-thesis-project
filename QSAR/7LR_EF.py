# -*- coding: utf-8 -*-
"""
Created on Sat Mar 16 03:09:14 2024
...
# 输出最佳参数和最佳得分
print("最佳参数：", grid_search.best_params_)#最佳参数是C=1 L1
...
EF_RF_ROC.to_csv('table/data12EF_LR_ROC.csv',header=True,index=False);  
...
MDs15.to_csv('table/data13EF_LR_fimp.csv',header=True,index=True)
...
selected_MDs.to_csv('table/data14EF_LR_fabun.csv',header=True, index = True)
...
confmat.to_csv('table/data15EF_LR_confmat.csv',header=True, index = True)

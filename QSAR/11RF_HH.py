# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 21:53:33 2024
...
print("Accuracy:", accuracy)#正确率0.5759
...
print("AUC Score:", auc_score)#0.5734
...
EF_RF_ROC.to_csv('table/data28HH_RF_ROC.csv',header=True,index=False);  
#画ROC图
#在R中
...
#存储importance值
MDs15.to_csv('table/data29HH_RF_fimp.csv',header=True, index = True)
...
selected_MDs.to_csv('table/data30HH_RF_fabun.csv',header=True, index = True)
...
confmat.to_csv('table/data31HH_RF_confmat.csv',header=True, index = True)
#在R中画混淆矩阵

# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 21:04:54 2024
...
print("AUC Score:", auc_score)#0.5462
...
EF_RF_ROC.to_csv('table/data20EC_SVM_ROC.csv',header=True,index=False);  
#用以上数据在R中画ROC图
...
MDs15.to_csv('table/data21EC_SVM_fimp.csv',header=True,index=True)
...
selected_MDs.to_csv('table/data22EC_SVM_fabun.csv',header=True, index = True)
...
confmat.to_csv('table/data23EC_SVM_confmat.csv',header=True, index = True)

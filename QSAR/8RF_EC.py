# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 20:45:33 2024
...
print("Accuracy:", accuracy)#正确率0.6335
...
print("AUC Score:", auc_score)#0.5919
...
EF_RF_ROC.to_csv('table/data16EC_RF_ROC.csv',header=True,index=False);  
#画ROC图
#在R中
...
#存储importance值
MDs15.to_csv('table/data17EC_RF_fimp.csv',header=True, index = True)
...
selected_MDs.to_csv('table/data18EC_RF_fabun.csv',header=True, index = True)
...
confmat.to_csv('table/data19EC_RF_confmat.csv',header=True, index = True)
#在R中画混淆矩阵

# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 22:33:50 2024
...
print("最优特征数:", best_n_features)#19
print('Best AUC: %.3f' % grid_search.best_score_)#0.650
...
fi.to_csv('特征重要性/EC_fSVM_fimp_8.csv',header=True, index = True)
...
print("在测试集上的正确率:", test_accuracy)#0.605
train_accuracy = model.score(X_train, y_train)
print("在训练集上的正确率:", train_accuracy)#0.700
full_set_accuracy = model.score(X, y)
print("在全集上的正确率:", full_set_accuracy)#0.672
...
EF_RF_ROC.to_csv('ROC曲线/EC_fSVM_ROC_8.csv',header=True,index=False);  
...
confmat.to_csv('混淆矩阵/EC_fSVM_confmat_8.csv',header=True, index = True)

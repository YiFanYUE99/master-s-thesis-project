# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 22:22:01 2024
...
# 输出最优参数
print("Best number of features:", grid_search.best_params_['fs__k'])#13
...
fi.to_csv('特征重要性/EC_fRF_fimp_7.csv',header=True, index = True)
...
print("在测试集上的正确率:", test_accuracy)#0.584
train_accuracy = model.score(X_train, y_train)
print("在训练集上的正确率:", train_accuracy)#0.990
full_set_accuracy = model.score(X, y)
print("在全集上的正确率:", full_set_accuracy)#0.868
...
EF_RF_ROC.to_csv('ROC曲线/EC_fRF_ROC_7.csv',header=True,index=False);  
...
confmat.to_csv('混淆矩阵/EC_fRF_confmat_7.csv',header=True, index = True)

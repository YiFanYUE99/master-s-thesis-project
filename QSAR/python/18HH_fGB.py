# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 23:34:45 2024
...
fi.to_csv('特征重要性/HH_fGB_fimp_18.csv',header=True, index = True)


# 在测试集上评估模型
y_pred_proba = model.predict_proba(X_test)[:, 1]
auc = roc_auc_score(y_test, y_pred_proba)
print("AUC:%.3f" % auc)#0.460
#训练集上评估模型
...
print("在训练集上的正确率:%.3f" % test_accuracy)#0.395
...
EF_RF_ROC.to_csv('ROC曲线/HH_fGB_ROC_18.csv',header=True,index=False);  
...
confmat.to_csv('混淆矩阵/HH_fGB_confmat_18.csv',header=True, index = True)

# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 22:12:00 2024
...
print("Best C:", grid_search.best_params_)#打出最优C:100
...
print("AUC Score:", auc_score)#0.5596
...
EF_RF_ROC.to_csv('table/data32HH_SVM_ROC.csv',header=True,index=False);  
#用以上数据在R中画ROC图
...
MDs15.to_csv('table/data33HH_SVM_fimp.csv',header=True,index=True)
...
selected_MDs.to_csv('table/data34HH_SVM_fabun.csv',header=True, index = True)
...
confmat.to_csv('table/data35HH_SVM_confmat.csv',header=True, index = True)

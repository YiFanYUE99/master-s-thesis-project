# -*- coding: utf-8 -*-
"""
Created on Tue Mar 19 22:36:52 2024
...
# 输出最佳参数和最佳得分
print("最佳参数：", grid_search.best_params_)#最佳参数是C=0.001 L2
print("最佳得分：", grid_search.best_score_)



# 初始化逻辑回归模型
logistic_regression = LogisticRegression(C= 0.001,penalty='l2',solver='saga')
# 在训练集上训练逻辑回归模型
...
print("AUC Score:", auc_score)#0.5420
...
EF_RF_ROC.to_csv('table/data36HH_LR_ROC.csv',header=True,index=False);  
...
MDs15.to_csv('table/data37HH_LR_fimp.csv',header=True,index=True)
...
selected_MDs.to_csv('table/data38HH_LR_fabun.csv',header=True, index = True)
...
confmat.to_csv('table/data39HH_LR_confmat.csv',header=True, index = True)
